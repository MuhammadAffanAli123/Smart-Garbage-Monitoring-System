       ...
       .then(function(querysnapshot){
           querysnapshot.forEach(function(doc){
              ...
              var getid= doc.data().iduser1;                              
               mycard12.innerHTML +=`<div className="card-columns"" style="width: 18rem; display: inline-block; margin-left:10px;" >
               <img className="card-img-top" src='${doc.data().image}' alt="Card image cap">
               <div class="card-body">
